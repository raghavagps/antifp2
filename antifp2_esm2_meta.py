...
# -*- coding: utf-8 -*-
"""
MetaPipeline: Prokka + fine-tuned ESM2 Antifungal Prediction
- Runs Prokka gene prediction
- Predicts antifungal proteins using fine-tuned ESM2
- Loads model files from Hugging Face cache
- Writes predictions and extracts positive sequences
"""
...
# ------------------------ Prediction ------------------------ #
def predict_sequences(fasta_file, output_csv, threshold=0.5, repo_id="raghavagps-group/antifp2"):
...
def main():
    ...
    try:
        ...
        positive_ids = predict_sequences(faa_file, output_csv, threshold=args.threshold, repo_id="raghavagps-group/antifp2")
